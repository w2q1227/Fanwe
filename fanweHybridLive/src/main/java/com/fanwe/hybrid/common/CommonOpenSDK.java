...
//        FWPay.pay(activity, order, payType, listner);
    ...
    public static void dealPayRequestSuccess(App_payActModel actModel, Activity activity, PayResultListner payResultListner, OnPayResultListener jbfPayResultListener)
    {
        ...
        if (payModel != null)
        {
            dealPayRequestSuccess(payModel, activity, payResultListner, jbfPayResultListener);
        } else
        {
    ...
    public static void dealPayRequestSuccess(PayModel payModel, Activity activity, PayResultListner payResultListner, OnPayResultListener jbfPayResultListener)
    {
