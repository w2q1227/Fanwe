...
public class InitActModel extends BaseActModel
{
    ...
    //娃娃
    private int has_billing;
    private int has_score;
    private int has_invitation;
    //是否开启积分商城
    private int open_score_shop;
    //签到弹窗开关
    private int open_login_send_diamonds;
    //注册赠送弹窗开关
    private int open_register_gift;

    //首次注册的奖励
    private String register_gift_diamonds;

    private List<WWMallTabTitleModel> doll_exchange_cate;//积分商城标题栏
    private int hide_network_notice;

    public int getHide_network_notice()
    {
        return hide_network_notice;
    }

    public void setHide_network_notice(int hide_network_notice)
    {
        this.hide_network_notice = hide_network_notice;
    }

    public int getHas_billing()
    {
        return has_billing;
    }

    public void setHas_billing(int has_billing)
    {
        this.has_billing = has_billing;
    }
    ...
    public void setHas_invitation(int has_invitation)
    {
    ...
    public int getOpen_score_shop()
    {
        return open_score_shop;
    }

    public void setOpen_score_shop(int open_score_shop)
    {
        this.open_score_shop = open_score_shop;
    }

    public String getRegister_gift_diamonds()
    {
        return register_gift_diamonds;
    }

    public void setRegister_gift_diamonds(String register_gift_diamonds)
    {
        this.register_gift_diamonds = register_gift_diamonds;
    }

    public int getOpen_login_send_diamonds()
    {
        return open_login_send_diamonds;
    }

    public void setOpen_login_send_diamonds(int open_login_send_diamonds)
    {
        this.open_login_send_diamonds = open_login_send_diamonds;
    }

    public int getOpen_register_gift()
    {
        return open_register_gift;
    }

    public void setOpen_register_gift(int open_register_gift)
    {
        this.open_register_gift = open_register_gift;
    }

    public List<WWMallTabTitleModel> getDoll_exchange_cate()
    {
        return doll_exchange_cate;
    }

    public void setDoll_exchange_cate(List<WWMallTabTitleModel> doll_exchange_cate)
    {
        this.doll_exchange_cate = doll_exchange_cate;
    }
}
