...
//        liveConfig.liveMsgListener = MessageEvent.getInstance()
            ILiveSDK.getInstance().initSdk(this,
                    SDTypeParseUtil.getInt(getString(R.string.app_id_tencent_live)),
                    SDTypeParseUtil.getInt(getString(R.string.account_type_tencent_live)));
...
//                LogUtil.i("Tencent Live SDK Version:" + TXLiveBase.getSDKVersionStr());
    ...
    public void logout(boolean post, boolean isStartLogin, boolean isStartH5Main)
    {
        ...
        if (isStartLogin)
        {
            Intent intent = new Intent(this, WWLoginActivity.class);
