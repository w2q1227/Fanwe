...
public class AppUpgradeHelper
{
    ...
    private void init()
    {
        notification = new SDNotification(applicationContext);

        apkDir = SDFileUtil.getCacheDir(applicationContext, "apk");
    }
        ...
        if (initActModel != null)
        {
            ...
            if (model != null)
            {
                ...
                if (serverVersion > localVersion)
                {
                    ...
                    apkName = applicationContext.getResources().getString(R.string.app_name) + "_" + serverVersion + ".apk";
    ...
    private void verifyDownloadUrl()
    {
        if (apkUrl.contains("fir.im"))
        {
