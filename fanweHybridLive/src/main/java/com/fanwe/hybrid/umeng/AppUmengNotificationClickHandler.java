...
import com.fanwe.catchdoll.push.WWReserveRunnable;
        ...
        if (pushMsg != null)
        {
            ...
            switch (pushMsg.getType())
            {
                case PushType.NORMAL:
                    runnable = new PushRunnable(context,msg);
                    break;
                case PushType.LIVE:
                ...
                case PushType.AUCTION_PAY:
                    ...
                    break;
                case PushType.WW_RESERVE:
                    runnable = new WWReserveRunnable(context,msg);
                    break;
                default:
                    runnable = new PushRunnable(context,msg);
                    break;
            ...
            if (runnable != null)
            {
                ...
                {
                    // app已经退出
                    runnable.setStartActivity(WWMainActivity.class);
