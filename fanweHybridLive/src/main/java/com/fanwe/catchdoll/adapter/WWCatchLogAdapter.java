...
public class WWCatchLogAdapter extends SDSimpleRecyclerAdapter<WWCatchLogModel>
{
    public WWCatchLogAdapter(List<WWCatchLogModel> listModel, Activity activity)
    {
    ...
    {
        return R.layout.ww_item_catch_log;
    }
