...
import com.fanwe.catchdoll.activity.WWHisDollListActivity;
    ...
    public void onBindData(SDRecyclerViewHolder<UserModel> holder, int position, final UserModel model)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                intent.putExtra(WWHisDollListActivity.EXTRA_ROOM_ID, LiveInformation.getInstance().getRoomId());
                intent.putExtra(WWHisDollListActivity.EXTRA_USER_ID, SDTypeParseUtil.getInt(model.getUser_id()));
