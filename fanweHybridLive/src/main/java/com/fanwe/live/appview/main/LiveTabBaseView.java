...
public abstract class LiveTabBaseView extends BaseAppView
{
    ...
    public static final long DURATION_LOOP = 5 * 1000;
     ...
     */
    protected final void startLoopRunnable()
    {
        startLoopRunnable(DURATION_LOOP);
    }

    protected final void startLoopRunnable(long duration)
    {
        getLooper().start(duration, mLoopRunnable);
    }
