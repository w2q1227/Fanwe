...
public class AppRuntimeWorker
{
    ...
    {
        App_RegionListActModel actModel = SDDisk.openInternal().getSerializable(App_RegionListActModel.class);
        if (actModel != null)
        {
            InitActModel initActModel = InitActModelDao.query();
...
//            activity.startActivity(intent);
    ...
    public static boolean isHideNetworkNotice()
    {
        InitActModel initActModel = InitActModelDao.query();
        if (initActModel != null)
        {
            return initActModel.getHide_network_notice() == 1;
        }
