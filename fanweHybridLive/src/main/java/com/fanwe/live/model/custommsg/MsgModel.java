...
public abstract class MsgModel
{
    ...
    public boolean isLiveQueueNotifyMsg()
    {
        return customMsgType == CustomMsgType.WW_MSG_QUEUE_NOTIFY;
    }
    ...
    public WWCustomMsgGame getCustomMsgWWGame()
    {
        return getCustomMsgReal();
    }

    public WWCustomMsgQueueNotify getCustomMsgQueueNotify()
    {
        return getCustomMsgReal();
    }

    public WWCustomMsgQueueUpdate getCustomMsgQueueUpdate()
    {
        return getCustomMsgReal();
    }
