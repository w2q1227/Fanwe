...
public class UserModel implements SDSelectManager.Selectable, Serializable
{
    ...
    //抓娃娃第二期新增用户是否已填写过验证码
    private String invite_code_written;//根据是否空字符判断就好了
     ...
     * @return
     */
    public boolean canScorePay(long score)
    {
    ...
    public String getInvite_code_written()
    {
        return invite_code_written;
    }

    public void setInvite_code_written(String invite_code_written)
    {
        this.invite_code_written = invite_code_written;
    }
}
