...
import com.fanwe.catchdoll.model.WWDollUrlModel;
...
public class App_get_videoActModel extends BaseActModel
{
    ...
    private WWAppDollModel doll;

    private List<WWDollUrlModel> doll_urls;

    private WWAppGameStartModel game_info;
    ...
    private int play_angle;
    private int play_angle2;
    ...
    public WWAppDollModel getDoll()
    {
        return doll;
    }

    public void setDoll(WWAppDollModel doll)
    {
        this.doll = doll;
    }
    ...
    public List<WWDollUrlModel> getDoll_urls()
    {
        return doll_urls;
    }

    public void setDoll_urls(List<WWDollUrlModel> doll_urls)
    {
        this.doll_urls = doll_urls;
    }

    public WWAppGameStartModel getGame_info()
    {
        return game_info;
    }

    public void setGame_info(WWAppGameStartModel game_info)
    {
    ...
    public int getPlay_angle()
    {
        return play_angle;
    }

    public void setPlay_angle(int play_angle)
    {
        this.play_angle = play_angle;
    }

    public int getPlay_angle2()
    {
        return play_angle2;
    }

    public void setPlay_angle2(int play_angle2)
    {
        this.play_angle2 = play_angle2;
    }

    @JSONField(serialize = false)
    public String getDollRtmpUrl(int index)
    {
        if (getDoll_urls() != null && getDoll_urls().size() > index)
        {
            return getDoll_urls().get(index).getRtmp();
        }
        return null;
    }
    ...
    public int getDollId()
    {
        if (getDoll() != null)
        {
            return SDTypeParseUtil.getInt(getDoll().getId());
        }
        return 0;
    }
    ...
    public boolean getIsSide()
    {
        if (getDoll() != null)
        {
            return SDTypeParseUtil.getInt(getDoll().getIs_side()) == 1;
        }
        return false;
    }
}
