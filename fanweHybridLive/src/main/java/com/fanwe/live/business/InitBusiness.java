...
import com.fanwe.catchdoll.activity.WWLoginActivity;
import com.fanwe.catchdoll.activity.WWMainActivity;
...
public class InitBusiness extends BaseBusiness
{
    ...
    {
        //启动本地广告图
        boolean isFirstOpenApp = SDDisk.openInternal().getBoolean(AppDiskKey.IS_FIRST_OPEN_APP, true);
...
//        Intent intent = new Intent(activity, LiveMainActivity.class);
        Intent intent = new Intent(activity, WWMainActivity.class);
        activity.startActivity(intent);
        activity.finish();
    }
    ...
    {
        Intent intent = new Intent(activity, WWLoginActivity.class);
        activity.startActivity(intent);
        activity.finish();
    }
    ...
    {
        SDActivityManager.getInstance().finishActivity(WWLoginActivity.class);
    }
