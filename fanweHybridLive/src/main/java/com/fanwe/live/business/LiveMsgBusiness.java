...
public class LiveMsgBusiness extends MsgBusiness
{
    ...
    protected void onMsgGroup(MsgModel msg)
    {
        ...
        {
            onMsgLargeGift(msg);
        }else if (LiveConstant.CustomMsgType.WW_MSG_GAME_START == type)
        {
            onMsgWWGameStart(msg);
        }else if (LiveConstant.CustomMsgType.WW_MSG_GAME_END == type)
        {
            onMsgWWGameEnd(msg);
        }else if (LiveConstant.CustomMsgType.WW_MSG_QUEUE_UPDATE == type)
        {
            onMsgWWQueueUpdate(msg);
        }else if (LiveConstant.CustomMsgType.WW_MSG_WAIT_CONFIRM == type)
        {
            onMsWWQueueWaitConfirm(msg);
        }
     ...
     *娃娃游戏开始通知
     */
    protected void onMsgWWGameStart(final MsgModel msg)
    {
        mBusinessCallback.onMsgWWGameStart(msg.getCustomMsgWWGame());
    }

    /**
     * 娃娃游戏结束通知
     */
    protected void onMsgWWGameEnd(final MsgModel msg)
    {
        mBusinessCallback.onMsgWWGameEnd(msg.getCustomMsgWWGame());
    }

    /**
     * 娃娃队列更新通知
     */
    protected void onMsgWWQueueUpdate(final MsgModel msg)
    {
        mBusinessCallback.onMsgWWQueueUpdate(msg.getCustomMsgQueueUpdate());
    }

    /**
     * 娃娃队列更新通知
     */
    protected void onMsWWQueueWaitConfirm(final MsgModel msg)
    {
        mBusinessCallback.onMsgWWQueueWaitConfirm(msg.getCustomMsgWWGame());
    }
    ...
    public interface LiveMsgBusinessCallback
    {
        ...
        void onMsgWWGameStart(WWCustomMsgGame wwCustomMsgGame);

        void onMsgWWGameEnd(WWCustomMsgGame wwCustomMsgGame);

        void onMsgWWQueueUpdate(WWCustomMsgQueueUpdate wwCustomMsgGame);

        void onMsgWWQueueWaitConfirm(WWCustomMsgGame wwCustomMsgGame);
    }
