    ...
    public void onPlayEvent(int event, Bundle param)
    {
        ...
        switch (event)
        {
            ...
            case TXLiveConstants.PLAY_EVT_RTMP_STREAM_BEGIN:
                LogUtil.i("----------PLAY_EVENT:" + event + " PLAY_EVT_RTMP_STREAM_BEGIN");
                break;
            ...
            case TXLiveConstants.PLAY_WARNING_RECONNECT:
                LogUtil.i("----------PLAY_EVENT:" + event + " PLAY_WARNING_RECONNECT");
                SDToast.showToast("视频正在重连...");
                break;
            ...
            case TXLiveConstants.PLAY_EVT_CHANGE_RESOLUTION:
                ...
                ELiveMeasureVideo eLiveMeasureVideo = new ELiveMeasureVideo();
                eLiveMeasureVideo.width = width;
                eLiveMeasureVideo.height = height;
                SDEventManager.post(eLiveMeasureVideo);
                break;
            default:
