...
public class LiveConstant
{
    ...
    public static final class CustomMsgType
    {
         ...
         *娃娃机游戏开始
         */
        public static final int WW_MSG_GAME_START = 201;

        /*
         *娃娃机游戏结束
         */
        public static final int WW_MSG_GAME_END = 202;
        /*
         *娃娃机游戏加入
         */
        public static final int WW_MSG_QUEUE_NOTIFY = 203;
        /*
         *娃娃机队列更新
         */
        public static final int WW_MSG_QUEUE_UPDATE = 204;
        /*
         *娃娃机队列等待确认
         */
        public static final int WW_MSG_WAIT_CONFIRM = 205;
    }
    ...
    static
    {
        ...
        mapCustomMsgClass.put(CustomMsgType.WW_MSG_GAME_START, WWCustomMsgGame.class);
        mapCustomMsgClass.put(CustomMsgType.WW_MSG_GAME_END, WWCustomMsgGame.class);
        mapCustomMsgClass.put(CustomMsgType.WW_MSG_QUEUE_NOTIFY, WWCustomMsgQueueNotify.class);
        mapCustomMsgClass.put(CustomMsgType.WW_MSG_QUEUE_UPDATE, WWCustomMsgQueueUpdate.class);
        mapCustomMsgClass.put(CustomMsgType.WW_MSG_WAIT_CONFIRM, WWCustomMsgGame.class);
    }
